...
#
#	func _init(lname: String, lres: String, lscale: Vector2, tArray: Texture2DArray, layer: int, transparent: bool = false):
#		self.name = lname
...
#	aTexture_mat.set_shader_parameter("texture_array", tArray)
#	aTextureTranslucent_mat.set_shader_parameter("texture_array", tArray)
#	aTexturePrototype_mat.set_shader_parameter("texture_array", tArray)
#
